...
class CreateQuestion extends React.Component {
    ...
    componentDidMount() {
      ...
      this.state.formData.id = parseInt(this.props.match.params.id, 10)
    }
    ...
    render() {
      return (
        ...
        <a href= {'/Quiz/'} > 
          ...
          <br/><br/>
          <h1 class="display-4 heading"> Update Question </h1>
          <form class="form" onSubmit = { this.handleSubmit }>
            <div class="form-group all extraWidth">
              <label for="Question"> Question! </label>
              <textarea required placeholder={ this.state.data.question } class="form-control" id="Question" onChange={this.handleQuestionChange} rows="3"></textarea>
            </div>
            <div class="row">
                <div class="col">
